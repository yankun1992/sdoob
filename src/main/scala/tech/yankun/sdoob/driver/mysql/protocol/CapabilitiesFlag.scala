...
object CapabilitiesFlag {
  ...
  val CLIENT_SUPPORTED_CAPABILITIES_FLAGS: Int = CLIENT_PLUGIN_AUTH | CLIENT_LONG_PASSWORD | CLIENT_LONG_FLAG | CLIENT_PLUGIN_AUTH_LENENC_CLIENT_DATA | CLIENT_SECURE_CONNECTION | CLIENT_PROTOCOL_41 | CLIENT_TRANSACTIONS | CLIENT_MULTI_STATEMENTS | CLIENT_MULTI_RESULTS | CLIENT_PS_MULTI_RESULTS | //    | CLIENT_SESSION_TRACK disable this it's not really used for now
    CLIENT_LOCAL_FILES
}
